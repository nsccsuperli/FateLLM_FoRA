...
class ModelArguments:
    ...
    #     metadata={"help": "The Importance Metric."},
    # )
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        import datasets
        raw_datasets = datasets.load_from_disk("/dt/ft/ChatGLM2-6B-main/LoRA-main/examples/NLGQA/"+data_args.dataset_name)
