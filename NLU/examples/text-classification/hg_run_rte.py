...
def main():
    ...
    if data_args.task_name is not None:
        ...
        import datasets
        datasets = datasets.load_from_disk("/dt/ft/ChatGLM2-6B-main/baichuan/glue/rte")
    else:
    ...
    model = AutoModelForSequenceClassification.from_pretrained(model_args.model_name_or_path, trust_remote_code=True
                                                 )
    print(model.base_model)
    target_modules = find_all_linear_names(model)
    # 待定
    #target_modules = ['value_proj', 'key_proj', 'query_proj','dense']
    ...
    if data_args.task_name is not None:
        import evaluate
        metric = evaluate.load("/dt/ft/baichuan-inc/Baichuan2-7B-Base/glue/glue.py",data_args.task_name)
